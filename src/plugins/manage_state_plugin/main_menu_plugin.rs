...
fn setup_mainmenu(mut commands: Commands) {
   ...
   // render a screen
   let screen_node = commands.spawn(NodeBundle {
      style: Style {
   ...
   let continue_button_entity = commands.spawn(( 
      ButtonBundle {
         style: Style {
            width: Val::Px(150.0),
            height: Val::Px(65.0),
   ...
   let quit_button_entity = commands.spawn((
      ButtonBundle {
         style: Style {
            width: Val::Px(150.0),
            height: Val::Px(65.0),
   ...
   commands.entity(screen_node).push_children(&vec![continue_button_entity, quit_button_entity]);
...
fn cleanup_mainmenu(
   ...
   mainmenu_data: Res<MainMenuData>
) {
   commands.entity(mainmenu_data.screen_node).despawn_recursive();
}
